...
namespace ElementsAndMaterials
{
    public partial class Form1 : Form
    {
        ...
        private void makeRequestToInsertOne(string material)
        {
            ...
            {
                case 0:
                    SQLhandler.makeRequesInsertOneElement(com, con, "0", "стекло нарезка", "732", "SN_", textBox1, textBox2.Text);
                    break;
                case 1:
                    SQLhandler.makeRequesInsertOneElement(com, con, "0", "стекло СП", "709", "S_", textBox1, textBox2.Text);
                    break;
                case 2:
                    SQLhandler.makeRequesInsertOneElement(com, con, "1", "рамки", "733", "R_", textBox1, textBox2.Text);
                    break;
                case 3:
                    SQLhandler.makeRequesInsertOneElement(com, con, "2", "шпроссы", "714", "SHP_S_", textBox1, textBox2.Text);
                    break;
                case 4:
                    SQLhandler.makeRequesInsertOneElement(com, con, "3", "пленки", "719", "П_", textBox1, textBox2.Text);
                    break;
                case 5:
                    SQLhandler.makeRequesInsertOneElement(com, con, "4", "ленты", "759", "KF_", textBox1, textBox2.Text);
                    break;
                default:
