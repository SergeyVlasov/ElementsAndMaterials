...
namespace ElementsAndMaterials
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e) => makeRequestToShow("0", "стекло нарезка");
        private void button12_Click(object sender, EventArgs e) => makeRequestToShow("0", "стекло СП");
        ...
        private void button7_Click(object sender, EventArgs e) => makeRequestToInsert("0", "стекло нарезка", "", "");
        private void button13_Click(object sender, EventArgs e) => makeRequestToInsert("0", "стекло СП", "", "");
        private void button8_Click(object sender, EventArgs e) => makeRequestToInsert("1", "рамки", "733", "R_");
        private void button9_Click(object sender, EventArgs e) => makeRequestToInsert("2", "шпроссы", "", "");
        private void button10_Click(object sender, EventArgs e) => makeRequestToInsert("3", "пленки", "719", "П ");
        private void button11_Click(object sender, EventArgs e) => makeRequestToInsert("4", "ленты", "", "");
